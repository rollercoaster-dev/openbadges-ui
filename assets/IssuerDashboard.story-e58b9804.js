import { aq as defineComponent, ar as ref, ay as computed, aE as watch, aF as onMounted, at as openBlock, az as createElementBlock, aA as createCommentVNode, ax as createBaseVNode, aG as normalizeClass, aH as withDirectives, aI as vShow, aw as createVNode, aJ as vModelText, aK as vModelSelect, as as resolveComponent, au as createBlock, av as withCtx } from "./vendor-6808bd13.js";
import { B as BadgeIssuerForm } from "./BadgeIssuerForm-93f4db2b.js";
import { B as BadgeList } from "./BadgeList-09055bf6.js";
import { _ as _export_sfc, B as BadgeService, m as mockAssertions } from "./mockData-2abc48a9.js";
    ...
    const filteredBadges = computed(() => {
      ...
      result.sort((a, b) => {
        if (sortOption.value === "newest" || sortOption.value === "oldest") {
          const dateA = "issuedOn" in a ? new Date(a.issuedOn).getTime() : "issuanceDate" in a ? new Date(a.issuanceDate).getTime() : 0;
          const dateB = "issuedOn" in b ? new Date(b.issuedOn).getTime() : "issuanceDate" in b ? new Date(b.issuanceDate).getTime() : 0;
...
//# sourceMappingURL=IssuerDashboard.story-e58b9804.js.map
